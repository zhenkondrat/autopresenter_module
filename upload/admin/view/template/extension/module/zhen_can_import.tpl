        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active" id="tab-export">
            <div class="btn-group dropup">
              <button type="button" class="btn btn-warning" style="margin-right: 25px; border-radius: 3px;" onclick="uploadData();">
                <span> Загрузить с прайса так как есть   <i class="fa fa-download fw" style="color: #ead801;"></i> </span>
              </button>
            </div>
